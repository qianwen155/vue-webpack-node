...
<div class="checking">
  <div class="top">
    <!-- <div class="history" @click="toVouchersList"></div> -->
    <div class="nub">
      <div class="nub-box" @click="sendBell">
        <!-- <p> 总收款</p>
        <p>{{accountArr.o2oGatheringTotal}}</p> -->
        <div class="icon_sendcheck"></div>
        <p>发送月历史账单</p>
      </div>
      <div class="bd"></div>
      <div class="nub-box" @click="toVouchersList">
        <!-- <p>总提现</p>
...
<script>
  import {getAccountMsg, getMonthly, getMonthlyList} from '@/vendor_api/checking'
  import swal from 'sweetalert2'
  export default {
    name: 'vendor_checking',
    data () {
      return {
        sign: '',
        page: 0,
...
//          console.log(that.page, '加载中。。。')
    ...
    methods: {
      sendBell () {
        this.$router.push('/vendor-sendChecking')
      },
      checkingDetail (mid, totalNumber, totalMoney) {
        this.$router.push('/vendor-checkingDetail/' + mid + '/' + totalNumber + '/' + totalMoney)
      },
      toVouchersList () {
        this.$router.push('/vendor-vendorvouchersList')
      },
      getMonthlyListS () {
    ...
    .top{
      ...
      .nub{
        .nub-box{
          ...
          p:nth-child(2){
            margin-top 0.2rem 
            font-size 0.3594594594594595rem;
            color #ffffff;
          }
          text-align center
